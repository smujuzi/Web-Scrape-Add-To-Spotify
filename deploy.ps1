...
aws cloudformation update-stack --stack-name webscrape-spotify-stack9 --template-body file://C:/Users/Stuart/OneDrive/AWS/spotify-webscraper/cloudFormation/lambda_cloud_formation_template.yaml --parameters ParameterKey=newFileName,ParameterValue=$new_fileName
